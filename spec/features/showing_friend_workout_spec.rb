...
RSpec.feature "Showing friends workout" do
    before do
        ...
        @e1 = @john.excercises.create(duration_in_min: 74, workout: "Weight lifting routine", workout_date: Date.today)
        @e2 = @sarah.excercises.create(duration_in_min: 55, workout: "Sarahs weight lifting routine", workout_date: Date.today)
    ...
    scenario "shows friend's workout for last 7 days" do
        ...
        expect(page).to have_content(@sarah.full_name + "'s Excercises")
